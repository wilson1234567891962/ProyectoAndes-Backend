package com.co.andes.management.adapter.email.repository;
...
public class EmailSMTPRepository implements EmailRepository {
	...
	public void sendEmail(EmailEMRequestDTO emailEMRequestDTO) throws MessagingException {
		...
		String html = "\n" +
				...
				"                                            tu contraseña del sistema de  cppm de la Andes</h1>\n" +
				"                                        <span\n" +
				...
				"\t\t\t\t\t\t\t\t\t\t</div>\n" +
				"\t\t\t\t\t\t\t\t\t\t<p style=\"color:#455056; font-size:15px;line-height:24px; margin:0;\">\n" +
				"                                         Email: "+emailEMRequestDTO.getEmail()+"\n" +
				"                                        </p>\n" +
				"\t\t\t\t\t\t\t\t\t\t<div  style=\"height:8px\">\n" +
				"\t\t\t\t\t\t\t\t\t\t</div>\n" +
				"\t\t\t\t\t\t\t\t\t\t<p style=\"color:#455056; font-size:15px;line-height:24px; margin:0;\">\n" +
				"                                         Password: "+ emailEMRequestDTO.getPassword()+"\n" +
				"                                        </p\n" +
				"                                        \n" +
				"                                    </td>\n" +
				"                                </tr>\n" +
